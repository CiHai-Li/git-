...
本目录用于展示价策 AI 在大商超业务背景下的跨部门协同机制。
...
- `价策AI_XX大商超跨部门协同流程图.vdx`：可使用 Microsoft Visio 打开并继续编辑。
- `价策AI_XX大商超跨部门协同流程图.svg`：矢量版本，适合网页和文档引用。
- `价策AI_XX大商超跨部门协同流程图_预览.png`：高清预览图，适合 GitHub 直接展示。

![价策 AI 跨部门协同流程图](价策AI_XX大商超跨部门协同流程图_预览.png)
