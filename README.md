...
这是一个面向电商运营、品类经理和定价团队的产品型作品。系统覆盖公开价格采集、同款报价归一、价格竞争力诊断、价格拐点分析、利润安全线、调价模拟和管理层报告，当前以母婴奶粉品类作为演示场景。
...
| 能力 | 解决的问题 | 产品输出 |
|---|---|---|
| 价格采集中心 | 竞品价格分散、更新慢 | 多平台报价快照、采集状态和来源线索 |
...
这是可运行的 MVP。采集中心提供稳定的演示快照和本地公开页采集服务；正式商业部署应申请京东、淘宝/天猫、拼多多等平台开放 API 权限。系统不会绕过登录、验证码、robots.txt 或平台访问限制，也不会自动执行调价。
