...
def build():
    ...
    add_body(doc, "价策 AI 是面向电商商家的价格情报与定价决策产品。系统从平台开放 API、合规公开商品页、用户本机授权态或 CSV 获得公开价与优惠条件，分层核算真实到手价，再结合商品价格、成本、销量、库存与商品角色，完成价格诊断、建议区间、调价模拟和可视化报告。")
    ...
    add_heading(doc, "11.1 同品牌头部 SKU 跨平台价格报告", 2)
    add_steps(doc, [
        "在报告中心选择需要分析的品牌。",
        "选择 Top 3、Top 5 或 Top 10；系统按近 30 天销量确定头部 SKU。",
        "横向比较每个 SKU 在京东、天猫、拼多多等平台的价格。",
        "查看最低价平台、跨平台价差率和价格结论。",
        "点击“导出品牌报告”下载 CSV。",
    ])
