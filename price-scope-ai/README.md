...
进入“价格采集中心”可选择“按品牌选品”，通过品牌、系列、规格和关键词筛选商家货盘，勾选目标 SKU 后配置平台与价格口径；系统会生成“SKU × 平台”任务，并将未找到高置信度同款的项目送入人工复核。进入“优惠策略中心”可查看公开售价、条件可实现价、已持券价及其优惠组成。演示界面的授权按钮仅展示工作流；正式接入必须由用户在平台官方页面完成一次登录。
