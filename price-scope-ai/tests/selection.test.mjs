...
const products = [
  { id: "A1", category: "食品", brand: "甲", series: "一系", stage: "2段", spec: "800g", name: "甲一系2段" },
  { id: "A2", category: "食品", brand: "甲", series: "二系", stage: "3段", spec: "700g", name: "甲二系3段" },
  { id: "B1", category: "家电", brand: "乙", series: "一系", stage: "2段", spec: "800g", name: "乙一系2段" },
];
...
test("品类筛选与品牌筛选联动", () => {
  assert.deepEqual(filterCatalog(products, { category: "家电" }).map((item) => item.id), ["B1"]);
});
